object input_transaksii: Tinput_transaksii
  Left = 225
  Top = 94
  BorderStyle = bsNone
  Caption = 'input_transaksii'
  ClientHeight = 516
  ClientWidth = 777
  Color = clBtnFace
  ...
  object sPanel1: TsPanel
    ...
    object gbox: TsGroupBox
      ...
      object cmb_kodprod: TsComboBox
        ...
        ParentFont = False
        TabOrder = 3
        Text = '--- Pilih Kode Produk ---'
        Visible = False
        OnClick = cmb_kodprodClick
        OnKeyPress = cmb_kodprodKeyPress
      end
      object edt_pengorder: TsEdit
        Left = 165
        Top = 98
        Width = 177
        Height = 26
      ...
      object sGroupBox5: TsGroupBox
        ...
        object rd_transfer: TsRadioButton
          Left = 73
          Top = 23
          Width = 78
          Height = 24
      ...
      object sGroupBox1: TsGroupBox
        ...
        Width = 249
        Height = 60
        Caption = 'Total Biaya Keseluruhan'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -15
        Font.Name = 'Calibri'
      ...
      object cmb_jenprod: TsComboBox
        ...
        OnClick = cmb_jenprodClick
        OnKeyPress = cmb_jenprodKeyPress
      end
      object cmb_warnprod: TsComboBox
        Left = 490
        Top = 77
        Width = 179
        Height = 26
        ...
        OnClick = cmb_warnprodClick
        OnKeyPress = cmb_warnprodKeyPress
      end
  ...
  object DataSource1: TDataSource
    DataSet = koneksii.qr_transktemp
    Left = 782
    Top = 8
  end
end
