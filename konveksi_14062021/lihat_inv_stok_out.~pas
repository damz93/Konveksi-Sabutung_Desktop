...
type
  Tlihat_inv_stok_outt = class(TForm)
    sPanel1: TsPanel;
...
var
  lihat_inv_stok_outt: Tlihat_inv_stok_outt;
...
{ Tlihat_inv_stok_outt }

procedure Tlihat_inv_stok_outt.baref;
begin
  input_inv_stokk.mrefresh2;
  kosong;
end;

procedure Tlihat_inv_stok_outt.koneksi;
begin
  ...
  begin
    koneksi;
      ...
      begin
        ...
        SQL.Clear;
        SQL.Text:='SELECT * FROM tbl_log_stok where KETERANGAN="Barang Keluar"';
        Active:=true;
      end;
  end;
end;

procedure Tlihat_inv_stok_outt.kosong;
begin   
...
procedure Tlihat_inv_stok_outt.mrefr_log;
begin
...
procedure Tlihat_inv_stok_outt.simp_log;
begin
    koneksii.putus;
with koneksii.qr_log do
  begin
...
procedure Tlihat_inv_stok_outt.tampil;
begin
...
procedure Tlihat_inv_stok_outt.btn_tambahClick(Sender: TObject);
begin
...
procedure Tlihat_inv_stok_outt.cmb_cariClick(Sender: TObject);
begin
...
procedure Tlihat_inv_stok_outt.DBGrid1CellClick(Column: TColumn);
begin
...
procedure Tlihat_inv_stok_outt.edit_cariChange(Sender: TObject);
begin
...
procedure Tlihat_inv_stok_outt.btn_hapusClick(Sender: TObject);
begin
...
procedure Tlihat_inv_stok_outt.btn_editClick(Sender: TObject);
begin
...
procedure Tlihat_inv_stok_outt.btn_batalClick(Sender: TObject);
begin
baref;
end;

procedure Tlihat_inv_stok_outt.btn_tutupClick(Sender: TObject);
begin
kosong;
  close;
end;

procedure Tlihat_inv_stok_outt.FormShow(Sender: TObject);
begin
baref;
end;
